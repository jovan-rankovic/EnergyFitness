        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                <form action="{{ url('/admin/users') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <p><i>Role:</i></p>
                        <input id="role_id1" name="role_id" type="radio" value="1" />
                        <label for="role_id1"> Admin </label>
                        <input id="role_id2" name="role_id" type="radio" value="2" />
                        <label for="role_id2"> User </label>
                    </div>
                    <div class="form-group">
                        <p><i>Active:</i></p>
                        <input id="active1" name="email_verified_at" type="radio" value="{{ date("Y-m-d H:i:s", time()) }}">
                    ...
                    <div class="form-group">
                        <button type="submit" name="userBtn" id="userBtn" class="btn btn-primary waves-effect waves-light">Create</button>
